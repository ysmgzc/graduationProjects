...
<!-- Mirrored from themes.pixelstrap.com/multikart/back-end/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Oct 2021 13:23:15 GMT -->
<head>
...
<g>
    ...
    <path style="fill:#808080;" d="M393.695,417.909l8.485-20.662l25.251,25.251c1.464,1.464,3.387,2.199,5.303,2.192
		c1.923,0,3.84-0.728,5.303-2.192l-83.142-83.142L393.695,417.909z"/>
                    ...
                    <div class="card tab2-card">
                        <div class="card-body">
                            <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="top-profile-tab" data-bs-toggle="tab" href="#top-profile" role="tab" aria-controls="top-profile" aria-selected="true"><span class="icon-user me-2"></span>Şifre Yenile</a>
                                </li>
                            </ul>
            ...
            <a href="{{route('login')}}" class="btn btn-primary back-btn"><i data-feather="arrow-left"></i>GİRİŞ SAYFASI</a>
        </div>
    </div>
</div>
